...
var MOCK_ANALYSIS_SECTIONS = [
  ...
  },
  {
    ...
    contentStatus: 'collected',
    imageStatus:   'na',
    koPreview:     'LINE (24시간, 제일 추천) / Instagram / MEDIFLOW 앱 (클릭 시 설치 안내 팝업 표시)',
    imageNote:     '',
    note:          'MEDIFLOW 안내 팝업 문구 설정 필요',
  },
  {
    num:           '10',
    name:          '푸터',
...
var MOCK_TRANSLATION_ROWS = [
  ...
  { num:'08', name:'서비스 보장',     icon:'🛡️', ko:'수술 후에도 일본으로 돌아온 후에도 케어가 계속됩니다. 예약부터 수술 후 케어까지, MEDIFLOW 일본어 전문 스탭이 모두 대응합니다.', ja:'', ts:'none' },
...
var MOCK_TRANSLATION_FALLBACK_JA = [
  ...
  '手術後、日本に帰国してからもケアは続きます。ご予約から術後ケアまで、MEDIFLOW日本語専門スタッフが全て対応します。',
